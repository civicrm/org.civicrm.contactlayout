<div {if $permission EQ 'edit'} class="crm-inline-edit" data-edit-params='{ldelim}"cid": "{$contactId}", "gid": {$block.block_id}, "class_name": "CRM_Contactsummary_Form_Inline_ProfileBlock"{rdelim}' {/if}>
